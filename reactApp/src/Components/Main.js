      ...
      <div>
        ...
        <div>
          ...
          <ButtonToolbar style={{marginTop:'3%'}}>
            <Button onClick= {(e) => {this.routeChange(e, 'tours')}} variant="outline-light" style={{ background:'#19B5FE', marginLeft:'10%',height:'60px',width: '20%', fontSize: '20px'}}>Get all tours</Button>
            ...
            <Button onClick= {(e) => {this.routeChange(e, 'points')}} variant="outline-light" style={{ background:'#19B5FE', marginLeft:'10%',height:'60px',width: '20%', fontSize: '20px'}}>Get all points</Button>
          </ButtonToolbar>
